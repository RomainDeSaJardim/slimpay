...
var SlimPay = (function () {
    ...
    _createClass(SlimPay, [{
        ...
        value: function config(_config) {
            ...
            if (!_config.password && _config.user) {
        ...
        key: 'slimPayApi',
        value: function slimPayApi(endPoint) {
            var _this2 = this;

            return this.checkToken().then(function (requestOptions) {
                return traverson.from(endPoint ? endPoint : _this2.endPoint).jsonHal().withRequestOptions(requestOptions);
            });
        }
    }, {
        key: 'getLinks',
        ...
        value: function get(link) {
            return this.slimPayApi(link).then(function (api) {
                return new _bluebird2['default'](function (resolve, reject) {
                    api.get(function (err, res, traversal) {
                        if (err) reject(err);else {
                            var body = JSON.parse(res.body);
